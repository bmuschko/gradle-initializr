= Gradle Initializer image:https://travis-ci.org/bmuschko/gradle-initializer.svg?branch=master["Build Status", link="https://travis-ci.org/bmuschko/gradle-initializer"]
